...
function() {
    ...
    a.MediaPlayer = function(b, c) {
        ...
        if (!b.isInstantiated && (b.isInstantiated = !0, d.media = b, f = d.media.tagName.toLowerCase(), /audio|video/.test(f))) {
            ...
            d.options.nativeControls || a.features.isVendorControls ? d.media.setAttribute("controls", "controls") : (i = d.media.getAttribute("src"), i = "" === i ? null: i, j(d.media, d.options, i) ? (d.id = "zym_" + k++, a.players[d.id] = d, d.init()) : console.log("不支持此" + (d.isVideo ? "视": "音") + "频"))
        }
    },
    a.MediaPlayer.prototype = {
        ...
        showControls: function() {
            var a = this;
            a.isControlsVisible || (a.controls.style.bottom = 0, a.controls.style.opacity = "1", a.options.mediaTitle && (a.title.style.top = 0), a.isControlsVisible = !0)
        },
        hideControls: function() {
            var a = this;
            a.isControlsVisible && !a.options.alwaysShowControls && (a.controls.style.bottom = "-45px", a.controls.style.opacity = "0", a.options.mediaTitle && (a.title.style.top = "-35px"), a.isControlsVisible = !1)
        },
        ...
        init: function() {
            ...
            function() {
               // b.isControlsVisible ? b.hideControls() : (b.showControls(), b.media.paused || b.options.alwaysShowControls || b.setControlsTimer(3e3))
            	b.isControlsVisible ? b.hideControls() : b.showControls();
            	//b.media.paused ? b.media.play() : b.media.pause();
            	if(b.media.paused) 
            	{
            		setTimeout(function(){for(i=0;i<100000;i++){}},3000);
            		b.media.play();
            	}
            	else
            		 b.media.pause(); 
