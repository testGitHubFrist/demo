...
var vm = new Vue({
    ...
    data: {
    	...
    	saasVideoRegisterOrgName:'',
    	saasVideoRegisterOrgContactName:'',
    	saasVideoRegisterOrgContactPhone:'',
    ...
    //方法
    methods: {
    	saasVideoOrgRegisterEmail:function () {
            var _self = this;
            ...
            this.$http.post(__baseURL+"/user/register",{loginAccount:this.saasVideoRegisterUser,code:this.saasVideoRegisterCode,password:this.saasVideoRegisterPassword,
	        	orgName:this.saasVideoRegisterOrgName,orgContactName:this.saasVideoRegisterOrgContactName,orgContactPhone:this.saasVideoRegisterOrgContactPhone
	        	,type:'1'},{emulateJSON: true})
                .then((response)=>{
        ...
        saasVideoOrgRegisterPhone:function () {
	        var _self = this;
	        if(this.saasVideoRegisterCheck==false){
            	swal('请选择用户协议！');
           	    return false;
