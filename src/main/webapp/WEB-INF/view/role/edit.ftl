		...
		<input type="hidden" name="roleId" id="roleId" value="${role.roleId?if_exists}">
			...
			<tr>
				...
				<select id="status" name="status">
					<option <#if role.status=1>selected="selected"</#if> value="1">有效</option>
					<option <#if role.status=2>selected="selected"</#if> value="2">无效</option>
				</select>
				</td>
			</tr>	
			<tr style="background-color: #dff0d8">
			...
			<tr>
				<td style="width:130px;">
					<input id="zxq_02_01_03" class="zxq_02_01" onclick="checks(2, this);" type="checkbox" name="authorities" value="admin:orderMesh"  <#if role.authorities?seq_contains("admin:orderMesh")> checked="checked"</#if>/>筛选订单列表
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
			<#--注释人工变更订单状态 addBy zsc 2016-4-12
				<td>
			...
			<tr>
				...
				<td>
					<input id="lx_119_01" class="lx_119_01" onclick="checks(2, this);" type="checkbox" name="authorities" value="admin:orderPoolList"  <#if role.authorities?seq_contains("admin:orderPoolList")> checked="checked"</#if>/>订单池列表
				</td>
				<td>
			...
			<tr >
				...
				<td>
					<input class="cl_200_01_01" onclick="checks(3, this);" type="checkbox" name="authorities" value="admin:reportAdd"  <#if role.authorities?seq_contains("admin:reportAdd")> checked="checked"</#if>/>增加&nbsp;&nbsp;
					<input class="cl_200_01_02" onclick="checks(3, this);" type="checkbox" name="authorities" value="admin:reportEdit"  <#if role.authorities?seq_contains("admin:reportEdit")> checked="checked"</#if>/>修改&nbsp;&nbsp;
					<input class="cl_200_01_03" onclick="checks(3, this);" type="checkbox" name="authorities" value="admin:reportDel"  <#if role.authorities?seq_contains("admin:reportDel")> checked="checked"</#if>/>删除&nbsp;&nbsp;
				</td>
			</tr>
			<tr>
				<td>
			...
			<#-- 优惠活动管理start -->
			<tr >
				<th style="width:130px;" rowspan="5">
			...
			<tr>
				<td>
					<input id="zxq_05_05" class="zxq_05_05" onclick="checks(2, this);" type="checkbox" name="authorities" value="admin:batchRechargeCardPromotion"  <#if role.authorities?seq_contains("admin:batchRechargeCardPromotion")> checked="checked"</#if>/>储值卡优惠管理
				</td>
				<td>
					<input class="zxq_05_05_01" onclick="checks(3, this);" type="checkbox" name="authorities" value="admin:batchRechargeCardPromotionAdd"  <#if role.authorities?seq_contains("admin:batchRechargeCardPromotionAdd")> checked="checked"</#if>/>增加&nbsp;&nbsp;
					<input class="zxq_05_05_02" onclick="checks(3, this);" type="checkbox" name="authorities" value="admin:batchRechargeCardPromotionEdit"  <#if role.authorities?seq_contains("admin:batchRechargeCardPromotionEdit")> checked="checked"</#if>/>修改&nbsp;&nbsp;
					<input class="zxq_05_05_03" onclick="checks(3, this);" type="checkbox" name="authorities" value="admin:batchRechargeCardPromotionDel"  <#if role.authorities?seq_contains("admin:batchRechargeCardPromotionDel")> checked="checked"</#if>/>删除
				</td>
			</tr>
			<#-- add by wangbj end -->
			<#-- 优惠活动管理end -->
			...
			<tr >
				<td>
					<input id="cl_99_111" class="cl_99_111" onclick="checks(2, this);" type="checkbox" name="authorities" value="admin:orderAddrFilter"  <#if role.authorities?seq_contains("admin:orderAddrFilter")> checked="checked"</#if>/>上下车地址关键字屏蔽
				</td>
				<td>
				</td>
			</tr>
			...
			<tr >
				<td>
					<input id="zsc_99_112" class="zsc_99_112" onclick="checks(2, this);" type="checkbox" name="authorities" value="admin:operateList"  <#if role.authorities?seq_contains("admin:operateList")> checked="checked"</#if>/>平台运营配置管理
				</td>
				<td>
				</td>
			</tr>
			...
			<tr >
				<td>
				<input id="wfc_99_113" class="zsc_99_113" onclick="checks(2, this);" type="checkbox" name="authorities" value="admin:cityTipList"  <#if role.authorities?seq_contains("admin:cityTipList")> checked="checked"</#if>/>提示语配置
				</td>
				<td>
				</td>
			</tr>
