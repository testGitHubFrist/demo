...
//		System.out.println(isCompleteBinaryTreeRec(r1));
	 ...
	 */
	public static TreeNode getLastCommonParentRec(TreeNode root, TreeNode n1,
			TreeNode n2) {
	...
	public static TreeNode getLastCommonParentRec2(TreeNode root, TreeNode n1,
			TreeNode n2) {
		if (root == null) {
			return null;
		}
	 ...
	 */
	public static TreeNode getLastCommonParent(TreeNode root, TreeNode n1,
			TreeNode n2) {
	...
	private static boolean getNodePath(TreeNode root, TreeNode node,
	...
	public static Result getMaxDistanceRec(TreeNode root) {
		...
		// 取情况A和情况B中较大值
		res.maxDistance = Math.max(lmd.maxDepth + rmd.maxDepth,
