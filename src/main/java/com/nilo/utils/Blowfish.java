...
public class Blowfish {
    ...
    /**
     * Encrypts a string (treated in UNICODE) using the standard Java random generator, which isn't that great for
     * creating IVs
     *
    ...
    private static class BlowfishECB {
        ...
        /**
         * Encrypts a byte buffer (should be aligned to an 8 byte border) to another buffer (of the same size or
         * bigger)
         *
        ...
        /**
         * encrypts an integer buffer (should be aligned to an two integer border) to another int buffer (of the same
         * size or bigger)
         *
         * @param inbuffer  buffer with plaintext data
         * @param outbuffer buffer to get the ciphertext data
        ...
        /**
         * decrypts a byte buffer (should be aligned to an 8 byte border) to another byte buffer (of the same size or
         * bigger)
         *
        ...
        /**
         * decrypts an integer buffer (should be aligned to an two integer border) to another int buffer (of the same
         * size or bigger)
         *
         * @param inbuffer  buffer with ciphertext data
         * @param outbuffer buffer to get the plaintext data
    ...
    private static class BlowfishCBC extends BlowfishECB {
        ...
        /**
         * encrypts an int buffer (should be aligned to an two integer border) to another int buffer (of the same size
         * or bigger)
         *
         * @param inbuffer  buffer with plaintext data
         * @param outbuffer buffer to get the ciphertext data
        ...
        /**
         * decrypts a byte buffer (should be aligned to an 8 byte border) to another buffer (of the same size or
         * bigger)
         *
         * @param inbuffer  buffer with ciphertext data
         * @param outbuffer buffer to get the plaintext data
     ...
     * @param nSrcPos     from which character in the string the conversion should begin, remember that (nSrcPos modulo
     *                    2) should equals 0 normally
